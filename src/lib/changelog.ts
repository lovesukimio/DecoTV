...
export const changelog: ChangelogEntry[] = [
  {
    ...
    date: '2026-02-12',
    added: [
      '⬇️ 视频资源文件下载: 新增下载管理能力，支持浏览器分片下载与 FFmpeg 转存下载',
      '🖥️ 网页投屏: 新增 Google Cast 投屏能力，并补充 iOS 设备兼容提示',
      '☁️ 网盘资源集成: 新增网盘页面与来源筛选，支持远程 PanSou 代理和后台节点管理',
      '📺 弹幕能力增强: 新增手动匹配、自定义弹幕服务器、多节点管理与自部署配置',
      '🎨 视觉升级: 首页登录支持自定义背景图，Logo 完成重新设计',
    ],
    changed: [
      '⚡ 全站性能优化: 虚拟化视频网格、加载更多逻辑与缓存策略持续优化',
      '🧠 弹幕模糊匹配优化: 优化弹幕搜索与匹配反馈流程，提升命中率与可控性',
      '📡 直播体验升级: 优化直播源分页切换和分类交互，支持 m3u8/flv/mp4 识别与处理',
      '🕹️ 导航与浏览优化: 调整导航栏与分页状态管理，降低加载抖动',
      '🎬 豆瓣信息爬取增强: 支持标题反查豆瓣 ID、并行抓取、图片防盗链与缓存失效更新',
    ],
    fixed: [
      '🐛 修复弹幕配置面板层级、保存与请求异常处理问题',
      '🐛 修复源浏览器回退与加载状态边界问题',
      '🐛 修复下载链路中的超时和错误格式化问题，提升稳定性',
    ],
  },
  {
    version: '1.2.0',
