...
const MobileBottomNav = ({ activePath }: MobileBottomNavProps) => {
  ...
  return (
    <nav
      className='md:hidden fixed left-0 right-0 z-600 bg-white/95 dark:bg-gray-900/95 backdrop-blur-none border-t border-gray-200/50 overflow-hidden dark:border-gray-700/50 mbnav'
      style={{
        /* 紧贴视口底部，同时在内部留出安全区高度 */
        bottom: 0,
